...
class GUI extends JFrame
{
    ...
    private JButton scanBtn,saveBtn,loadBtn,exportBtn,contrastBtn,configBtn;
    ...
    public GUI(Arduino ard)
    {
        ...
        contrastBtn = new JButton("Contrast");
        contrastBtn.addActionListener(btnListener);
        ...
        board.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e) {
                if(e.getX()>0 && e.getX()<601 && e.getY()>0 && e.getY()<601) {
                    ...
                    mouseIntensity.setText("Intensity: " + grey(mouseX,mouseY));
        ...
        contour.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e) {
                if(e.getX()>0 && e.getX()<301 && e.getY()>12 && e.getY()<313) {
                    ...
                    intensity = grey(mouseX,mouseY);
                    
                    contour.setToolTipText("<html>Blue indicates low intensity while orange indicate high intensity<br>Current step: "
                                            + intensity/currentContourStep*currentContourStep);
                }
            }
        });
        ...
        contrastBtn.setToolTipText("Increases the contrast on the image");
    ...
    class Contour extends JPanel
    {
        ...
        public void updatePixel(int x, int y, int intensity, int currentContourStep) 
        {
            ...
            //100+(int)((intensity/currentContourStep*currentContourStep)/1023.0*155.0)
